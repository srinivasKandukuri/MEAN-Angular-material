...
/*
// unplash random images;

.controller('mainCtrl', function($scope, Ajax){
  
  var image = Ajax.unsplash();
  image.then(function(res){
           $scope.bgImage = {
              'background-image':'url('+ res.data.urls.full +')',
              'background-attachment':'fixed',
              'background-repeat': 'center center fixed no-repeat',
